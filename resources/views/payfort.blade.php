...
<col style="width: 197px">
  ...
  <tr>
    <th class="tg-yw4l" colspan="2">Customer ordered via credit card. Payment details found below<br></th>
  </tr>
  <tr>
    <td class="tg-yw4l">Customer Email:</td>
    <td class="tg-yw4l">{{$email}}</td>
  </tr>
  <tr>
    <td class="tg-yw4l">SOLO Order ID:</td>
    <td class="tg-yw4l">{{$order_id}}</td>
  </tr>
  <tr>
    <td class="tg-yw4l">Order Code:</td>
    <td class="tg-yw4l">{{$order_code}}</td>
  </tr>
  <tr>
    <td class="tg-yw4l">fort_id:</td>
    <td class="tg-yw4l">{{$fort_id}}</td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-yw4l">merchant_reference:</td>
    <td class="tg-yw4l">{{$merchant_reference}}</td>
  </tr>
  <tr>
    <td class="tg-yw4l"></td>
